...
make -j `nproc` image=tomee-benchmark img_format=raw || handle_test_error
...
python3 apps/tomee/jenkins/tomee-xml.py -o tomee-perf.xml -m tps $WRK_OUT_FILE || handle_test_error
